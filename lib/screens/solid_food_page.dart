...
class _SolidFoodPageState extends State<SolidFoodPage> {
  ...
  static const _foodTypeOptions = ['谷物', '肉类', '水产', '蔬菜', '水果', '其他'];
  ...
  Widget _timeRow() => Padding(
    ...
    child: Row(
      children: [
        const Text('记录时间', style: TextStyle(fontSize: 16, color: Colors.black)),
        const Spacer(),
  ...
  Widget _ateRow() => Padding(
    ...
    child: Row(
      children: [
        const Text('是否进食', style: TextStyle(fontSize: 16, color: Colors.black)),
        const Spacer(),
        SizedBox(
          width: 24,
          height: 24,
  ...
  Widget _amountRow() => Padding(
    ...
    child: Row(
      children: [
        const Text('进食量', style: TextStyle(fontSize: 16, color: Colors.black)),
        const Spacer(),
        // Toggle buttons
        _unitToggle('数量'),
        const SizedBox(width: 8),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(8),
          border: Border.all(
            color: sel ? const Color(0xFFDDDDDD) : Colors.transparent,
          ),
        ),
        child: Text(
          label,
    ...
    child: Column(
      ...
      children: [
        ...
        Wrap(
          spacing: 10,
          runSpacing: 10,
          children: _foodTypeOptions.map((t) => _foodTypeChip(t)).toList(),
        ),
      ],
    ),
  );
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: sel ? _kPurple : const Color(0xFFDDDDDD)),
        ),
        child: Text(
          type,
          style: TextStyle(
    ...
    child: Column(
      ...
      children: [
        ...
        SingleChildScrollView(
          ...
          child: Row(
            children: _textureOptions.map((t) => _textureItem(t)).toList(),
          ),
        ),
      ],
    ),
  ...
  Widget _textureItem(_TextureOption opt) {
    ...
    return GestureDetector(
      onTap: () => setState(() => _texture = sel ? null : opt.label),
      child: Padding(
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Center(
                child: Text(opt.emoji, style: const TextStyle(fontSize: 30)),
              ),
            ),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 12,
                color: sel ? _kPurple : const Color(0xFF666666),
              ),
            ),
          ],
        ),
  ...
  Future<void> _pickDate() async {
    ...
    if (p != null) {
      setState(
        () =>
            _time = DateTime(p.year, p.month, p.day, _time.hour, _time.minute),
      );
    }
  }
  ...
  void _save() {
    ...
    Provider.of<AppProvider>(context, listen: false).addSolidFood(
      SolidFoodEntry(
        ...
        timestamp: _time,
        ate: _ate,
        amount: amtStr.isEmpty ? null : double.tryParse(amtStr),
        unit: _unit,
