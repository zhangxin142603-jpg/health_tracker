...
class _MedicationPageState extends State<MedicationPage> {
      ...
      children: [
        Row(
          children: [
            ...
            GestureDetector(
              ...
              child: const Text(
                '+ 添加',
                style: TextStyle(fontSize: 15, color: _kPurple),
              ),
            ),
          ],
        ),
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Container(width: 0.5, height: 20, color: const Color(0xFFCCCCCC)),
              const SizedBox(width: 8),
              SizedBox(
                width: 80,
                child: TextField(
        ...
        Wrap(
          ...
          children: [
            ...
            ..._kCommonMeds.map((m) => _commonMedChip(m, isAdd: false)),
          ],
        ),
      ],
    ),
  ...
  Widget _medChip(String name) => Container(
    ...
    child: Row(
      ...
      children: [
        Text(name, style: const TextStyle(fontSize: 13, color: _kPurple)),
  ...
  Widget _commonMedChip(String label, {required bool isAdd}) => GestureDetector(
    onTap: () {
  ...
  void _save() {
    ...
    Provider.of<AppProvider>(context, listen: false).addMed(
      MedEntry(
